...
- The action skills (remember, recall, and the rest) are installed separately with `npx skills add Xuleileon/agentmemory`. `connect` makes tools available; skills teach the agent when to use them.
